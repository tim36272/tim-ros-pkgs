...
(cl:in-package wifi_localization-msg)
...
(cl:defclass <WifiData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector wifi_localization-msg:AccessPoint)
   :initform (cl:make-array 0 :element-type 'wifi_localization-msg:AccessPoint :initial-element (cl:make-instance 'wifi_localization-msg:AccessPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WifiData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WifiData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wifi_localization-msg:<WifiData> is deprecated: use wifi_localization-msg:WifiData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <WifiData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifi_localization-msg:header-val is deprecated.  Use wifi_localization-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <WifiData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifi_localization-msg:data-val is deprecated.  Use wifi_localization-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WifiData>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'wifi_localization-msg:AccessPoint))

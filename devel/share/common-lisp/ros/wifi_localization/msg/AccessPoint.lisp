...
(cl:defmethod cl:initialize-instance :after ((m <AccessPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccessPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wifi_localization-msg:<AccessPoint> is deprecated: use wifi_localization-msg:AccessPoint instead.")))

(cl:ensure-generic-function 'mac_address-val :lambda-list '(m))
(cl:defmethod mac_address-val ((m <AccessPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifi_localization-msg:mac_address-val is deprecated.  Use wifi_localization-msg:mac_address instead.")
  (mac_address m))

(cl:ensure-generic-function 'ss-val :lambda-list '(m))
(cl:defmethod ss-val ((m <AccessPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifi_localization-msg:ss-val is deprecated.  Use wifi_localization-msg:ss instead.")
  (ss m))

(cl:ensure-generic-function 'noise-val :lambda-list '(m))
(cl:defmethod noise-val ((m <AccessPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wifi_localization-msg:noise-val is deprecated.  Use wifi_localization-msg:noise instead.")
  (noise m))
